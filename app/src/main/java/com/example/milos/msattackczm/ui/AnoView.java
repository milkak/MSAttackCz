...
public class AnoView extends View {
    ...
    public AnoView(Context context) {
        super(context);
        init(context);
    }

    public AnoView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public AnoView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onDraw(Canvas canvas) {
      ...
      // Log.d( "Radius " + radius," "+x+" "+y+" "+width+" "+height);
        ...
        canvas.drawText("Příznaky",x-30,59,paint);

      //  paint.setFakeBoldText(true);
        paint.setTextSize(20);
        canvas.drawText("po dobu",x-30,76,paint);
        canvas.drawText("24 hod",x-30,94,paint);
        ...
        canvas.drawPath(mShape.getPath(), mShape.getPaint());
        canvas.drawText("Přetrvávající",x-181,150,paint);
        canvas.drawText("po odpočinku",x-181,175,paint);
        canvas.drawText("čí spánku ",x-181,193,paint);


        mShape.setPolygon(x+131, 170,(float) 69.39, 6);
        canvas.drawPath(mShape.getPath(), mShape.getPaint());
        canvas.drawText("Zlepšení",x+85,150,paint);
        canvas.drawText("po odpočinku",x+85,175,paint);
        canvas.drawText("čí spánku ",x+85,193,paint);
        ...
        canvas.drawText("Neprodělal ",x+90,295,paint);
        canvas.drawText("jsem žádnou ",x+90,315,paint);
        canvas.drawText("námahu.",x+90,330,paint);
       ...
       // mShape.setCircle(337,190,(float) 49.39,Path.Direction.CW);
        ...
        canvas.drawLine(x-131,230, x-176, 253, paint);
        canvas.drawLine(x-131, 230, x-86, 253, paint);

        // draw circle
        paint.setTextSize(20);

        canvas.drawCircle(x-190, 305,(float) 55.39 , p);
        canvas.drawText("Mám",x-210,295,paint);
        canvas.drawText("infekci. ",x-210,315,paint);

        // draw circle

        canvas.drawCircle(x-65, 305,(float) 55.39 , p);
        canvas.drawText("Nemám",x-90,295,paint);
        canvas.drawText("infekci.",x-90,315,paint);
